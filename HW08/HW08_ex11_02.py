...
# (1) Use get to write histogram_old more concisely as histogram_new. You
# should be able to eliminate the if statement.

# (2) Use histogram_new in a new function to take pledge.txt and create a dict
# histogram with word counts (do not change the case of the words).
###############################################################################
# Notes:
#   - There are two examples provided for removing punctuation:
#       - list comprehension with a conditional checking for characters
#         in string.ascii_letters
#       - regular expression using re.split() (docs 7.2)
###############################################################################
